...
- PulseRelay Canary Fresh turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called PulseRelay Canary Fresh. PLATFORM: game. TECH_STACK: browser-game-canvas. QUALITY_SCOPE: small controlled canary; do not add project-specific platform behavior to Setfarm or Mission Control. CANARY_RUN_PURPOSE: validate Setfarm and Mission Control stack-module behavior aft…
...
- Gameplay - PulseRelay Canary Fresh
- Game Settings - PulseRelay Canary Fresh

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - PulseRelay Canary Fresh
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - PulseRelay Canary Fresh
